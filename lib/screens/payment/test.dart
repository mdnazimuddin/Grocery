...
class _PaymentState extends State<Payment> {
  ...
  final String _currentSecret =
      "sk_test_51HNXgAHgY7podxftRljyY3ydV69mug4KitDczQG5qPvj8BjJ7P4FMykFVa8r7rCZKQmG0YETNEaTbAcLLXMWZFU500irE2hm2h"; //set this yourself, e.g using curl
  ...
  initState() {
    ...
    StripePayment.setOptions(StripeOptions(
        publishableKey:
            "pk_test_51HNXgAHgY7podxftCx2NHqWrfDQro9sXLXnCRxj7cN09djUGj0JVbbK7vYsHWfM6JR1R7IRX5MLl4vQOO1JxzFwv00HITHsPzB",
        merchantId: "Test",
        androidPayMode: 'test'));
  }
